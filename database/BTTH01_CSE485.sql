...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th2 22, 2023 lúc 02:37 PM
...
--
ALTER TABLE `baiviet`
  ADD CONSTRAINT `ma_tgia` FOREIGN KEY (`ma_tgia`) REFERENCES `baiviet` (`ma_bviet`),
  ADD CONSTRAINT `ma_tloai` FOREIGN KEY (`ma_tloai`) REFERENCES `baiviet` (`ma_bviet`);
COMMIT;
